...
$sql = "SELECT * FROM product JOIN subcategory on product.subcategory_idsubcategory=subcategory.idsubcategory JOIN category ON subcategory.category_idcategory=category.idcategory WHERE category.idcategory=1;";
