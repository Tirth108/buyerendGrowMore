...
$sql = "SELECT * FROM product JOIN subcategory on product.subcategory_idsubcategory=subcategory.idsubcategory JOIN category ON subcategory.category_idcategory=category.idcategory WHERE category.idcategory=3;";
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="fabric.php">Fabrics</a></li>
