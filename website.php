	...
	while($row = mysqli_fetch_assoc($result))
	{
		echo'							<div class="product">
											<div class="product-img">
												<img src='.$row['image'].' alt="Sorry , image is not found due to error" height=200px width=150px>
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href=product.php?pid='.$row['idproduct'].'>'.$row['pname'].'</a></h3>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Fabrics</a></li>
									<li><a data-toggle="tab" href="#tab2">Kid's Wear</a></li>
									<li><a data-toggle="tab" href="#tab2">Women's Wear</a></li>
									<li><a data-toggle="tab" href="#tab2">Men's Wear</a></li>
								</ul>
							</div>
						</div>
					</div>
