...
$id=$_GET['pid'];
$sid=$_GET['sellerid'];
$sql="SELECT * FROM product INNER JOIN subcategory INNER JOIN category ON product.subcategory_idsubcategory=subcategory.idsubcategory where idproduct = $id AND product.subcategory_idsubcategory=category.idcategory";
